export const OPEN_WEATHER_CITIES = [
...
{label: "Basse-Terre", value: "Basse-Terre"},
...
{label: "Road Town", value: "Road Town"},
{label: "Rome", value: "Rome"},
{label: "Roseau", value: "Roseau"},
{label: "Saint George's", value: "Saint George's"},
{label: "Saint Helier", value: "Saint Helier"},
{label: "Saint John's", value: "Saint John's"},
{label: "Saint Peter Port", value: "Saint Peter Port"},
